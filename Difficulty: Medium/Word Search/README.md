<h2><a href="https://www.geeksforgeeks.org/problems/word-search/1?page=1&category=Recursion,Backtracking&difficulty=Easy,Medium&status=unsolved&sortBy=submissions">Word Search</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a 2D board of letters and a word. Check if the word exists in the board. The word can be constructed from letters of adjacent cells only. ie - horizontal or vertical neighbors. The same letter cell can not be used more than once.</span></p>
